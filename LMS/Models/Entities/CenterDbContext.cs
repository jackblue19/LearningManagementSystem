...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=TOANBACH;Database=CenterLMS;User Id=sa;Password=123;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Attendance>(entity =>
        {
            entity.HasKey(e => e.AttendanceId).HasName("PK__Attendan__8B69261C124DD948");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__AuditLog__5E548648CBCA3E9F");
        ...
        {
            entity.HasKey(e => e.CenterId).HasName("PK__Centers__398FC7F73871BF88");
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__Classes__CB1927C0BE9FFD53");
        ...
        {
            entity.HasKey(e => e.MaterialId).HasName("PK__ClassMat__C50610F798E62FDE");
        ...
        {
            entity.HasKey(e => e.RegistrationId).HasName("PK__ClassReg__6EF5881027E7A4EA");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__ClassSch__9C8A5B498D2D61DF");
        ...
        {
            entity.HasKey(e => e.ExamId).HasName("PK__Exams__297521C7F57488DA");
        ...
        {
            entity.HasKey(e => e.ResultId).HasName("PK__ExamResu__97690208C2774386");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDD6EC6161AD");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E128A25BE20");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A381D4A72E9");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Rooms__328639397B299971");
        ...
        {
            entity.HasKey(e => e.AvailabilityId).HasName("PK__RoomAvai__DA3979B1678AED6C");
        ...
        {
            entity.HasKey(e => e.BatchId).HasName("PK__Schedule__5D55CE585D794E12");
        ...
        {
            entity.HasKey(e => e.SubjectId).HasName("PK__Subjects__AC1BA3A8D89BA123");
        ...
        {
            entity.HasKey(e => e.AvailabilityId).HasName("PK__TeacherA__DA3979B11311F65D");
        ...
        {
            entity.HasKey(e => e.SlotId).HasName("PK__TimeSlot__0A124AAFE6258BF0");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C7484170B");
